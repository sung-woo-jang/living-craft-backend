...
export class ServiceSeeder {
  private generateServiceData(index: number) {
    ...
    const additionalServices = [
      {
        name: '원룸 청소',
        description: '원룸, 오피스텔 전용 청소 서비스입니다. 작은 공간도 꼼꼼하게 관리해드립니다.',
        type: ServiceType.FIXED,
        price: 35000,
        duration: 90,
      },
      {
        name: '펜션/숙박업소 청소',
        description: '펜션이나 숙박업소 청소 서비스입니다. 다음 손님을 위해 완벽하게 정리해드립니다.',
        type: ServiceType.FIXED,
        price: 100000,
        duration: 240,
      },
      {
        name: '카페/매장 청소',
        description: '카페나 작은 매장의 청소 서비스입니다. 영업 시간을 고려하여 스케줄 조정 가능합니다.',
        type: ServiceType.FIXED,
        price: 70000,
        duration: 120,
      },
      {
        name: '신축/리모델링 후 청소',
        description: '신축이나 리모델링 후 발생하는 공사 먼지와 오염물질을 제거하는 전문 청소 서비스입니다.',
        type: ServiceType.CUSTOM,
        price: null,
        duration: 300,
      },
      {
        name: '입주/퇴거 청소',
        description: '이사 시 입주 전후 청소 서비스입니다. 보증금 반환을 위한 완벽한 청소를 제공합니다.',
        type: ServiceType.FIXED,
        price: 90000,
        duration: 200,
      },
  ...
  async run(dataSource: DataSource): Promise<void> {
    ...
    for (let i = existingServicesCount; i < existingServicesCount + baseServicesToCreate; i++) {
