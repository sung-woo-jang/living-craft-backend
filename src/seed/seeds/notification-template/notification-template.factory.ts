...
const NotificationTemplateFactory = localeKoSetSeederFactory(
  NotificationTemplate,
  (faker) => {
    ...
    const templateMap = {
      ...
      [NotificationType.QUOTE_REJECTED]: {
        sms: '견적이 거절되었습니다. 다른 문의사항이 있으시면 연락 주세요.',
        email: {
          subject: '견적 거절 안내',
          content: `안녕하세요 {{customerName}}님,\n\n견적이 거절되었습니다.\n\n다른 서비스나 문의사항이 있으시면 언제든 연락 주세요.\n\n감사합니다.`,
        },
      },
