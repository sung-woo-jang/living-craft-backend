...
export default class PortfolioSeeder implements Seeder {
  async run(dataSource: DataSource, factoryManager: SeederFactoryManager): Promise<any> {
    ...
    const basePortfolios = [
      {
        title: '아파트 일반 청소 사례',
        description: '30평 아파트 전체 일반 청소 작업 사례입니다. 거실, 침실, 주방, 화장실을 깔끔하게 정리했습니다.',
      ...
      {
        title: '사무실 정기 청소',
        description: '30인 규모 사무실 정기 청소 서비스 사례입니다. 책상, 의자, 바닥을 체계적으로 청소했습니다.',
      ...
      {
        title: '이사 후 입주 청소',
        description: '이사 후 남은 먼지와 오염물질을 완전히 제거하여 쾌적한 환경를 만들었습니다.',
      ...
      {
        title: '카페 매장 청소',
        description: '개성 있는 카페 공간을 깔끔하게 정리하여 고객들이 편안하게 이용할 수 있도록 했습니다.',
    ...
    const additionalPortfolios = await factoryManager.get(PortfolioImage).saveMany(
