...
export class AuthController {
  ...
  async adminLogin(@Body() loginDto: LoginRequestDto): Promise<SuccessBaseResponseDto<LoginResponseDto>> {
  ...
  async verifyGuest(@Body() verifyDto: VerifyGuestRequestDto): Promise<SuccessBaseResponseDto<any>> {
  ...
  async getProfile(@CurrentUser() user: any): Promise<SuccessBaseResponseDto<any>> {
  ...
  async getNaverAuthUrl(): Promise<SuccessBaseResponseDto<{ url: string }>> {
    ...
    return new SuccessBaseResponseDto('네이버 인증 URL을 반환했습니다.', { url });
  }
  ...
  async naverCallback(@Request() req: any): Promise<SuccessBaseResponseDto<LoginResponseDto>> {
